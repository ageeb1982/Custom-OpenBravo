...
//        jcboLAF.addItem(new UIManager.LookAndFeelInfo("Openbravo", "com.openbravo.pos.skin.OpenbravoLookAndFeel"));
    ...
    private void initComponents() {
        ...
        jLabelWarehouse = new JLabel();
        jLabelWarehouse.setText("Skin");
        		...
        		.addGroup(jPanel13Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel13Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel13Layout.createSequentialGroup()
        					...
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(m_jDisplayParams, GroupLayout.DEFAULT_SIZE, 488, Short.MAX_VALUE))
        				.addGroup(jPanel13Layout.createSequentialGroup()
        					...
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(m_jPrinterParams1, GroupLayout.DEFAULT_SIZE, 488, Short.MAX_VALUE))
        				.addGroup(jPanel13Layout.createSequentialGroup()
        					...
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(m_jPrinterParams2, GroupLayout.DEFAULT_SIZE, 488, Short.MAX_VALUE))
        				.addGroup(jPanel13Layout.createSequentialGroup()
        					...
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(m_jPrinterParams3, GroupLayout.DEFAULT_SIZE, 488, Short.MAX_VALUE))
        				.addGroup(jPanel13Layout.createSequentialGroup()
        					...
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(m_jScaleParams, GroupLayout.DEFAULT_SIZE, 488, Short.MAX_VALUE))
        				.addGroup(jPanel13Layout.createSequentialGroup()
        					.addGroup(jPanel13Layout.createParallelGroup(Alignment.LEADING)
        						.addGroup(jPanel13Layout.createSequentialGroup()
        					...
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(m_jScannerParams, GroupLayout.DEFAULT_SIZE, 488, Short.MAX_VALUE))
        				.addGroup(jPanel13Layout.createSequentialGroup()
        				...
        				.addGroup(jPanel13Layout.createSequentialGroup()
        					.addComponent(jLabelWarehouse, GroupLayout.PREFERRED_SIZE, 130, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        ...
        layout.setVerticalGroup(
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			.addContainerGap()
        			.addComponent(jPanel13, GroupLayout.DEFAULT_SIZE, 385, Short.MAX_VALUE)
        			.addContainerGap())
        );
    ...
    private JLabel jLabelWarehouse;
