...
public class CustomersView extends javax.swing.JPanel implements EditorRecord {
    ...
    public CustomersView(AppView app, DirtyManager dirty) {
        ...
        //	Dixon Martinez
        m_SentCountry = dlCustomers.getCountrysList();
        m_CountryModel = new ComboBoxValModel();
        
        m_SentRegion = dlCustomers.getRegion();
        m_RegionModel = new ComboBoxValModel();
        
        m_SentCity = dlCustomers.getCitysList();
        m_CityModel = new ComboBoxValModel();
        ...
        //	Dixon Martinez
        m_IsTaxExempt.addActionListener(dirty);
//        jCmbCountry.addActionListener(dirty);
        //	End Dixon Martinez
    ...
    public void activate() throws BasicException {
        ...
        a = m_SentCountry.list();
//        a.add(0, null); // The null item
        m_CountryModel = new ComboBoxValModel(a);
        jCmbCountry.setModel(m_CountryModel);
     
        a = m_SentRegion.list();
//        a.add(0, null); // The null item
        m_RegionModel = new ComboBoxValModel(a);
        jCmbRegion.setModel(m_RegionModel);
        
        a = m_SentCity.list();
//        a.add(0, null); // The null item
        m_CityModel = new ComboBoxValModel(a);
        jCmbCity.setModel(m_CityModel);
     
        setJcmbCountriesList();
        setJcmbRegionList();
        setCityList();
    ...
    public void writeValueEOF() {
        ...
        //	Dixon Martinez
        m_IsTaxExempt.setEnabled(false);
    ...
    public void writeValueInsert() {
        ...
        //	Dixon Martinez
        m_IsTaxExempt.setEnabled(true);
        jCmbCountry.setEnabled(true);
        jCmbCity.setEnabled(true);
        jCmbRegion.setEnabled(true);
        setJcmbCountriesList();
        setJcmbRegionList();
        setCityList();
        //	End Dixon Martinez
    ...
    public void writeValueDelete(Object value) {
        ...
        //	Dixon Martinez
        m_IsTaxExempt.setSelected(customer[23].toString().equals("Y") ? true : false);
        m_IsTaxExempt.setEnabled(false);
        jCmbCountry.setEnabled(false);
        jCmbCity.setEnabled(false);
        jCmbRegion.setEnabled(false);
        setJcmbCountriesList();
        setJcmbRegionList();
        setCityList();
        //	End Dixon Martinez
...
//    	Object[] customer = new Object[23];
        ...
        //	Dixon Martinez
        customer[23] = m_IsTaxExempt.isSelected() ? "Y" : "N";
        //	End Dixon Martinez
    ...
    private void initComponents() {
        ...
        jCmbCountry.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		if(isActiveEvent) {
        			CountryInfo cInfo = (CountryInfo) jCmbCountry.getSelectedItem();
        			 txtCountry.setText(cInfo.getM_Name());
                     try {
						setRegionList(cInfo.getM_C_Country_ID());
        ...
        jCmbRegion = new JComboBox();
        
        jCmbRegion.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		if(isActiveEvent) {
        			RegionInfo rInfo = (RegionInfo) jCmbRegion.getSelectedItem();
        			 txtRegion.setText(rInfo.getM_Name());
                     try {
						setCityList(rInfo.getM_C_Region_ID());
					} catch (BasicException e1) {
						// TODO Auto-generated catch block
						e1.printStackTrace();
					}
        ...
        jCmbCity.addActionListener(new ActionListener() {
        	public void actionPerformed(ActionEvent e) {
        		if(isActiveEvent) {
        			CityInfo cInfo = (CityInfo) jCmbCity.getSelectedItem();
        			 txtCity.setText(cInfo.getM_Name());
        		}
        	}
        });
        	...
        	jPanel2Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(jPanel2Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(jPanel2Layout.createSequentialGroup()
        					.addComponent(jLabel13, GroupLayout.PREFERRED_SIZE, 140, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(txtAddress, GroupLayout.PREFERRED_SIZE, 270, GroupLayout.PREFERRED_SIZE))
        				.addGroup(jPanel2Layout.createSequentialGroup()
        					.addComponent(jLabel21, GroupLayout.PREFERRED_SIZE, 140, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(txtAddress2, GroupLayout.PREFERRED_SIZE, 270, GroupLayout.PREFERRED_SIZE))
        				.addGroup(jPanel2Layout.createSequentialGroup()
        					.addComponent(jLabel22, GroupLayout.PREFERRED_SIZE, 140, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(txtPostal, GroupLayout.PREFERRED_SIZE, 270, GroupLayout.PREFERRED_SIZE))
        				.addGroup(jPanel2Layout.createParallelGroup(Alignment.TRAILING, false)
        					.addGroup(Alignment.LEADING, jPanel2Layout.createSequentialGroup()
        						.addComponent(jLabel23, GroupLayout.PREFERRED_SIZE, 140, GroupLayout.PREFERRED_SIZE)
        						.addPreferredGap(ComponentPlacement.RELATED)
        						.addComponent(jCmbCity, GroupLayout.PREFERRED_SIZE, 239, GroupLayout.PREFERRED_SIZE)
        						.addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        						.addComponent(txtCity, GroupLayout.PREFERRED_SIZE, 54, GroupLayout.PREFERRED_SIZE))
        					.addGroup(Alignment.LEADING, jPanel2Layout.createSequentialGroup()
        						.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
        							.addGroup(jPanel2Layout.createSequentialGroup()
        								.addComponent(jLabel20, GroupLayout.PREFERRED_SIZE, 140, GroupLayout.PREFERRED_SIZE)
        								.addPreferredGap(ComponentPlacement.RELATED)
        								.addComponent(jCmbCountry, GroupLayout.PREFERRED_SIZE, 239, GroupLayout.PREFERRED_SIZE)
        								.addPreferredGap(ComponentPlacement.RELATED))
        							.addGroup(Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
        								.addComponent(jLabel24, GroupLayout.PREFERRED_SIZE, 140, GroupLayout.PREFERRED_SIZE)
        								.addPreferredGap(ComponentPlacement.RELATED)
        								.addComponent(jCmbRegion, GroupLayout.PREFERRED_SIZE, 239, GroupLayout.PREFERRED_SIZE)
        								.addGap(211)))
        						.addGroup(jPanel2Layout.createParallelGroup(Alignment.LEADING)
        							.addComponent(txtRegion, GroupLayout.PREFERRED_SIZE, 55, GroupLayout.PREFERRED_SIZE)
        							.addComponent(txtCountry, GroupLayout.PREFERRED_SIZE, 53, GroupLayout.PREFERRED_SIZE)))))
        	...
        	jPanel2Layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(jPanel2Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel2Layout.createParallelGroup(Alignment.BASELINE)
        				...
        				.addComponent(jCmbCountry, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addGroup(jPanel2Layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(jLabel24)
        				.addComponent(txtRegion, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        				.addComponent(jCmbRegion, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addGroup(jPanel2Layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(jLabel23)
        				.addComponent(txtCity, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
        				.addComponent(jCmbCity, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        			.addGap(16))
        );
        ...
        JLabel lblExcentoDeImpuesto = new JLabel();
        lblExcentoDeImpuesto.setText(AppLocal.getIntString("label.IsTaxExempt"));
        
        m_IsTaxExempt = new JCheckBox("");
        	...
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addGroup(layout.createParallelGroup(Alignment.LEADING)
        				.addComponent(jTabbedPane1, GroupLayout.DEFAULT_SIZE, 810, Short.MAX_VALUE)
        				.addGroup(layout.createSequentialGroup()
        					.addGroup(layout.createParallelGroup(Alignment.LEADING, false)
        						.addGroup(layout.createSequentialGroup()
        							.addComponent(jLabel7, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE)
        							.addPreferredGap(ComponentPlacement.RELATED)
        							.addComponent(m_jTaxID, GroupLayout.PREFERRED_SIZE, 270, GroupLayout.PREFERRED_SIZE))
        						.addGroup(layout.createSequentialGroup()
        							.addComponent(jLabel8, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE)
        							.addPreferredGap(ComponentPlacement.RELATED)
        							.addComponent(m_jSearchkey, GroupLayout.PREFERRED_SIZE, 270, GroupLayout.PREFERRED_SIZE))
        						.addGroup(layout.createSequentialGroup()
        							.addComponent(jLabel3, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE)
        							.addPreferredGap(ComponentPlacement.RELATED)
        							.addComponent(m_jName, GroupLayout.PREFERRED_SIZE, 270, GroupLayout.PREFERRED_SIZE))
        						.addGroup(layout.createSequentialGroup()
        							.addGroup(layout.createParallelGroup(Alignment.LEADING)
        								.addGroup(layout.createSequentialGroup()
        									.addGroup(layout.createParallelGroup(Alignment.LEADING)
        										.addGroup(layout.createSequentialGroup()
        											...
        											.addPreferredGap(ComponentPlacement.RELATED)
        											.addComponent(jcard, GroupLayout.PREFERRED_SIZE, 270, GroupLayout.PREFERRED_SIZE))
        										.addGroup(layout.createSequentialGroup()
        											.addComponent(jLabel9, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE)
        											.addGap(12)
        											.addComponent(m_jCategory, GroupLayout.PREFERRED_SIZE, 270, GroupLayout.PREFERRED_SIZE)))
        									.addPreferredGap(ComponentPlacement.RELATED))
        								.addGroup(layout.createSequentialGroup()
        									.addComponent(jLabel4, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE)
        									.addPreferredGap(ComponentPlacement.RELATED, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        									.addComponent(m_jVisible, GroupLayout.PREFERRED_SIZE, 140, GroupLayout.PREFERRED_SIZE)
        									.addGap(142)))
        							.addGroup(layout.createParallelGroup(Alignment.LEADING)
        								.addComponent(lblExcentoDeImpuesto)
        								.addGroup(layout.createSequentialGroup()
        									.addComponent(jButton2)
        									.addPreferredGap(ComponentPlacement.RELATED)
        									.addComponent(jButton3)))))
        					.addPreferredGap(ComponentPlacement.UNRELATED)
        					.addComponent(m_IsTaxExempt))
        				.addGroup(layout.createSequentialGroup()
        					.addComponent(jLabel1, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(txtMaxdebt, GroupLayout.PREFERRED_SIZE, 130, GroupLayout.PREFERRED_SIZE))
        				.addGroup(layout.createSequentialGroup()
        					.addComponent(jLabel2, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(txtCurdebt, GroupLayout.PREFERRED_SIZE, 130, GroupLayout.PREFERRED_SIZE))
        				.addGroup(layout.createSequentialGroup()
        					.addComponent(jLabel6, GroupLayout.PREFERRED_SIZE, 180, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(txtCurdate, GroupLayout.PREFERRED_SIZE, 130, GroupLayout.PREFERRED_SIZE)))
        			.addContainerGap())
        );
        	...
        	layout.createParallelGroup(Alignment.LEADING)
        		.addGroup(layout.createSequentialGroup()
        			...
        			.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        				...
        				.addComponent(m_jTaxID, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        				.addComponent(jLabel8)
        				.addComponent(m_jSearchkey, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        			.addPreferredGap(ComponentPlacement.RELATED)
        			.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        			...
        			.addGroup(layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(layout.createSequentialGroup()
        					.addGroup(layout.createParallelGroup(Alignment.LEADING)
        						...
        						.addComponent(m_jVisible, GroupLayout.PREFERRED_SIZE, 20, GroupLayout.PREFERRED_SIZE))
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        						.addComponent(jLabel1)
        						.addComponent(txtMaxdebt, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        						.addComponent(jLabel2)
        						.addComponent(txtCurdebt, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        						.addComponent(jLabel6)
        						.addComponent(txtCurdate, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
        				.addGroup(layout.createParallelGroup(Alignment.BASELINE)
        					.addComponent(lblExcentoDeImpuesto)
        					.addComponent(m_IsTaxExempt)))
        			.addGap(18)
    ...
    //	Dixon Martinez
    private JCheckBox m_IsTaxExempt;
    private JComboBox jCmbCountry ;
    private JComboBox jCmbRegion ;
    private JComboBox jCmbCity ;
    
    private SentenceList m_SentCountry;
    private ComboBoxValModel m_CountryModel;

    private SentenceList m_SentRegion;
    private ComboBoxValModel m_RegionModel;
    
    private SentenceList m_SentCity;
    private ComboBoxValModel m_CityModel;
    
    
    boolean isActiveEvent;
    private DataLogicCustomers dlCustomers;
    
    private void setRegionList(String p_Country_ID) throws BasicException {
    	m_SentRegion = dlCustomers.getRegionByCountry(p_Country_ID);
		List a = m_SentRegion.list();
        m_RegionModel = new ComboBoxValModel(a);
        jCmbRegion.setModel(m_RegionModel);
	}
    
    private void setCityList(String p_C_Region_ID) throws BasicException {
    	m_SentCity = dlCustomers.getCitysByRegion(p_C_Region_ID);
		List a = m_SentCity.list();
		m_CityModel = new ComboBoxValModel(a);
        jCmbCity.setModel(m_CityModel);
	}
    
    private void setJcmbCountriesList(){
        int index =0;
        for(index =0;index< jCmbCountry.getItemCount(); index ++){
            if((jCmbCountry.getItemAt(index)).toString().equalsIgnoreCase(txtCountry.getText())){
            	jCmbCountry.setSelectedIndex(index);
                break;
            }
        }
    }
    
    private void setJcmbRegionList(){
        int index =0;
        for(index =0;index< jCmbRegion.getItemCount(); index ++){
            if((jCmbRegion.getItemAt(index)).toString().equalsIgnoreCase(txtRegion.getText())){
            	jCmbRegion.setSelectedIndex(index);
                break;
            }
        }
    }
    ...
    private void setCityList(){
        int index =0;
        for(index =0;index< jCmbCity.getItemCount(); index ++){
            if((jCmbCity.getItemAt(index)).toString().equalsIgnoreCase(txtCity.getText())){
            	jCmbCity.setSelectedIndex(index);
                break;
            }
        }
    }
