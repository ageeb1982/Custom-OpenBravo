...
public class DataLogicCustomers extends BeanFactoryDataSingle {
    ...
    private static Datas[] customerdatas = new Datas[] {Datas.STRING, Datas.TIMESTAMP, Datas.TIMESTAMP, Datas.STRING, Datas.STRING, Datas.STRING, Datas.STRING, Datas.INT, Datas.BOOLEAN, Datas.STRING, Datas.STRING};
    ...
    public void init(Session s){
        ...
        tcustomers = new TableDefinition(s
            ...
            , new String[] { "ID", AppLocal.getIntString("label.taxid"), AppLocal.getIntString("label.searchkey"), AppLocal.getIntString("label.name"), AppLocal.getIntString("label.notes"), "VISIBLE", "CARD", AppLocal.getIntString("label.maxdebt"), AppLocal.getIntString("label.curdate"), AppLocal.getIntString("label.curdebt")
                           ...
                           //	Dixon Martinez
                           , AppLocal.getIntString("label.IsTaxExempt")
                           //	End Dixon Martinez
    ...
    public final SentenceList getCountrysList() {
        return new StaticSentence(s
            , "SELECT C_Country_ID, Name FROM C_Country ORDER BY NAME"
            , null
            , new SerializerRead() { public Object readValues(DataRead dr) throws BasicException {
                return new CountryInfo(dr.getString(1), dr.getString(2));
            }});
    }
    
    public final SentenceList getCitysList() {
    	String sql = "SELECT C_City_ID, Name, C_Region_ID FROM C_City ORDER BY NAME";
        return new StaticSentence(s
            , sql
            , null
            , new SerializerRead() { public Object readValues(DataRead dr) throws BasicException {
            	return new CityInfo(dr.getString(1), dr.getString(2), dr.getString(3));
            }});
    }
    
    public final SentenceList getCitysByRegion(String p_C_Region_ID) throws BasicException {
    	
    	String sql = "SELECT C_City_ID, Name, C_Region_ID FROM C_City WHERE C_Region_ID = '" + p_C_Region_ID + "' ORDER BY NAME";
    	return new StaticSentence(s
    	            , sql
    	            , null
    	            , new SerializerRead() { public Object readValues(DataRead dr) throws BasicException {
    ...
    public final SentenceList getRegionList() {
        return new StaticSentence(s
            , "SELECT C_Region_ID, Name, C_Country_ID FROM C_Region ORDER BY NAME"
            , null
            , new SerializerRead() { public Object readValues(DataRead dr) throws BasicException {
                return new RegionInfo(dr.getString(1), dr.getString(2), dr.getString(3));
            }});
    }
    
    public final SentenceList getRegion() {
    	String sql = "SELECT C_Region_ID, Name, C_Country_ID FROM C_Region ORDER BY NAME"; 
        return new StaticSentence(s
            , sql
            , null
            , new SerializerRead() { public Object readValues(DataRead dr) throws BasicException {
    ...
    public final SentenceList getRegionByCountry(String p_C_Country_ID) throws BasicException {
    	String sql = "SELECT C_Region_ID, Name, C_Country_ID FROM C_Region WHERE C_Country_ID = '" + p_C_Country_ID + "' ORDER BY NAME";
    	return new StaticSentence(s
    	            , sql
    	            , null
    	            , new SerializerRead() { public Object readValues(DataRead dr) throws BasicException {
