...
public class DataLogicSystem extends BeanFactoryDataSingle {
    ...
    private SentenceFind m_locationfindByDefault;
    private SentenceFind m_locationfindIdByDefault;
    ...
    public void init(Session s){
        ...
        resetResourcesCache();  
        m_locationfindByDefault = new StaticSentence(s
                , "SELECT NAME FROM LOCATIONS WHERE IsDefault = 'Y'"
                , SerializerWriteString.INSTANCE
                , SerializerReadString.INSTANCE);
        resetResourcesCache();
        
        m_locationfindIdByDefault = new StaticSentence(s
                , "SELECT ID FROM LOCATIONS WHERE IsDefault = 'Y'"
                , SerializerWriteString.INSTANCE
                , SerializerReadString.INSTANCE);
        resetResourcesCache();
    }
...
//    public abstract BaseSentence getShutdown();
    ...
    //	Dixon Martinez
    public final String findLocationName(boolean isDefault) throws BasicException {
        return (String) m_locationfindByDefault.find(isDefault ? "Y" : "N");
    }
    
    public final String findLocationID(boolean isDefault) throws BasicException {
        return (String) m_locationfindIdByDefault.find(isDefault ? "Y" : "N");
    }
    //	End Dixon Martinez
}
