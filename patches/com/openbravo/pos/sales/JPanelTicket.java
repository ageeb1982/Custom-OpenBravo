...
//    private ScriptObject scriptobjinst;
    ...
    public class ScriptObject {
        ...
        public Object evalScript(String code, ScriptArg... args) throws ScriptException {
        	...
        	//	Dixon Martinez 2015-01-24 
        	//	Add support for verify inventory 
        	String p_User	= m_App.getProperties().getProperty("db.user");
        	String p_Password = m_App.getProperties().getProperty("db.password");
        	if(p_User != null
        			&& (p_Password != null  
        					&& p_Password.startsWith("crypt:"))
        					)	{
        		AltEncrypter cypher =
        				new AltEncrypter("cypherkey" + p_User);
        		p_Password = cypher.decrypt(p_Password.substring(6));
        	}
        	
        	script.put("hostname", m_App.getProperties().getHost());
        	script.put("dbURL", m_App.getProperties().getProperty("db.URL"));
        	script.put("dbUser", p_User);
        	script.put("dbPassword", p_Password);
        	//	End Dixon Martinez
